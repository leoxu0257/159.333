...
public class MainActivity extends Activity {
    ...
    boolean mCollide;
    public static BubbleType TYPE = BubbleType.TRIANGLE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean enable = mPreferences.getBoolean("circle", false);
        if (enable) {
            TYPE = BubbleType.CIRCULAR;
        }
        enable = mPreferences.getBoolean("hexagon", false);
        if (enable) {
            TYPE = BubbleType.HEXAGON;
        }
        enable = mPreferences.getBoolean("square", false);
        if (enable) {
            TYPE = BubbleType.SQUARE;
        }
        enable = mPreferences.getBoolean("triangle", false);
        if (enable) {
            TYPE = BubbleType.TRIANGLE;
        }
